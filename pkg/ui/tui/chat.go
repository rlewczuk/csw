...
type ChatWidget struct {
	...
	// Mutex for thread-safe updates from SessionThreadOutput
	mu sync.Mutex
}

// NewChatWidget creates a new chat widget with the given session controller.
func NewChatWidget(controller *core.SessionThread) (*ChatWidget, error) {
...
// SessionThreadOutput implementation
