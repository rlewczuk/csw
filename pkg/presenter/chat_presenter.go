...
// AddThinkingChunk is called when new thinking/reasoning content is generated by LLM.
// Implements core.SessionThreadOutput.
func (p *ChatPresenter) AddThinkingChunk(thinking string) {
	p.mu.Lock()
	view := p.view
	...
	p.currentAssistantMessage.Thinking += thinking
