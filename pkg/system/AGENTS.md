...
* `bootstrap_paths.go` - config/workdir path resolution helpers for bootstrap and run flows
* `bootstrap_models.go` - model/provider resolution and model tag registry helpers for bootstrap
