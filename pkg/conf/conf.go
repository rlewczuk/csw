...
type ModelVendorFamilyTemplateOverride struct {
	...
	Vendor ModelProviderConfig `json:"vendor,omitempty"`
	// Families contains family-specific overrides for the vendor.
	Families map[string]ModelProviderConfig `json:"families,omitempty"`
}
...
type ModelProviderConfig struct {
	...
	DefaultTemperature float32 `json:"default-temperature,omitempty"`
	// DefaultTopP is the default top_p for chat completions
	DefaultTopP float32 `json:"default-top-p,omitempty"`
	// DefaultTopK is the default top_k for chat completions
	DefaultTopK int `json:"default-top-k,omitempty"`
	// ContextLengthLimit is the maximum number of tokens to use for context
	ContextLengthLimit int `json:"context-length-limit,omitempty"`
	...
	MaxInputTokens int `json:"max-input-tokens,omitempty"`
	// MaxOutputTokens is the maximum number of output tokens generated by the model.
	MaxOutputTokens int `json:"max-output-tokens,omitempty"`
	...
	ModelTags []ModelTagMapping `json:"model-tags,omitempty"`
	...
	ReasoningContent string `json:"reasoning-content,omitempty"`
	...
	ToolCall *bool `json:"tool-call,omitempty"`
	...
	Cost []ModelProviderCost `json:"cost,omitempty"`
	// Modalities defines input/output modalities supported by the model.
	Modalities *ModelProviderModalities `json:"modalities,omitempty"`
	...
	QueryParams map[string]string `json:"query-params,omitempty"`
	...
	RateLimitBackoffScale int `json:"rate-limit-backoff-scale,omitempty"`
	// AuthMode specifies the authentication mode for the provider.
	// Possible values: "none", "api_key" (default), "oauth2".
	AuthMode AuthMode `json:"auth-mode,omitempty"`
	...
	DisableRefresh bool `json:"disable-refresh,omitempty"`
}
...
type GlobalConfig struct {
	...
	ToolSelection ToolSelectionConfig `json:"tool-selection,omitempty"`
	...
	ContextCompactionThreshold float64 `json:"context-compaction-threshold,omitempty"`
	// LLMRetryMaxAttempts is the maximum number of attempts for temporary LLM API failures.
	// Defaults to 10 when unset or invalid.
	LLMRetryMaxAttempts int `json:"llm-retry-max-attempts,omitempty"`
...
type CswConfig struct {
	...
	AgentRoleConfigs map[string]*AgentRoleConfig `json:"agent-role-configs,omitempty"`
	...
	ModelProviderConfigs map[string]*ModelProviderConfig `json:"model-provider-configs,omitempty"`
	...
	AgentConfigFiles map[string]map[string]string `json:"agent-config-files,omitempty"`
