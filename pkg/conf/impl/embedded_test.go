...
func TestEmbeddedConfigStore_GetAgentRoleConfigs(t *testing.T) {
	...
	assert.Contains(t, allRole.ToolFragments, "skill/skill.md")
	assert.Contains(t, allRole.ToolFragments, "skill/skill.schema.json")
	assert.Contains(t, allRole.ToolFragments, "skill/.tooldir")
