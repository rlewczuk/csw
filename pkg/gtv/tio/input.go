...
func NewInputEventReader(reader io.Reader, writer io.Writer, handler gtv.InputEventHandler) *InputEventReader {
...
func (r *InputEventReader) parseCSI(data []byte) int {
	...
	case 'A': // Up arrow
		r.handler.Notify(gtv.InputEvent{
			Type:      gtv.InputEventKey,
			Key:       'A',
			Modifiers: r.getModifiers(params) | gtv.ModFn,
		})
		return end
...
func (r *InputEventReader) getModifiers(params []int) gtv.EventModifiers {
